        ...
        return (
            <div className="App">
              ...
              />*/}
                ...
                {this.state.regions.length > 0 && activeTab === "tab1" && (
                    <div className="white-section">
                        <ClimateSettings
                            regions={this.state.regions}
                            season={this.state.season}
                ...
                {this.state.regions.length > 0 && activeTab === "tab2" && (
                    <div className="white-section">
                        <HealthWellbeing
                ...
                {this.state.regions.length > 0 && activeTab === "tab3" && (
                    <div className="white-section">
                        <Vulnerabilities regions={this.state.regions} regionType={this.state.regionType} />
                    </div>
                )}

                {this.state.regions.length > 0 && activeTab === "tab4" && (
                    <div className="white-section">
                        <Adaptations
                            networkParser={this.state.networkParser}
                            year={this.state.year}
